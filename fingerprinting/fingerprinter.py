...
class Fingerprinter:
    ...
    def extract_fingerprints(self, input_file):
...
def main():
    ...
    parser.add_option('-f','--fp_db',action='store',dest='fp_db',help='location of fingerprint database',default='resources/fingerprint_db.json.gz')
    ...
    fingerprinter.extract_fingerprints(options.input)
